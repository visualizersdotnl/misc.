...
vec3 lOff()
{    
    vec2 u = sin(vec2(0.96, 0.) - time*0.624); // EDIT: made this range smaller & movement slower
...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    // EDIT
    float decay = 0.14;
    float density = 1.731274;
    float weight = 0.7*2.428; 
